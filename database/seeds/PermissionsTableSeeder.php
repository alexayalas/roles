...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create([
            ...
            'slug'          => 'users.edit',
            'description'   => 'Edicion de cualquier usuario del sistema',
        ]);
        Permission::create([
        ...
        Permission::create([
            ...
            'slug'          => 'roles.edit',
            'description'   => 'Edicion de cualquier rol del sistema',
        ]);        
        Permission::create([
        ...
        Permission::create([
            ...
            'slug'          => 'products.show',
            'description'   => 'Ver en detalle un producto del sistema',
        ]);
        Permission::create([
            'name'          => 'Creacion de productos',
            'slug'          => 'products.create',
            'description'   => 'Creacion de un producto del sistema',
        ]);
        Permission::create([
            'name'          => 'Edicion de productos',
            'slug'          => 'products.edit',
            'description'   => 'Edicion de cualquier producto del sistema',
        ]);        
        Permission::create([
